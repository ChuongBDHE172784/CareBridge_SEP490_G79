...
# TEST SPECIFICATION — Track Fetal Movement Sessions

| Field | Value |
| --- | --- |
| Document ID | `UC-MH-08-TEST-SPEC` |
| Version | `0.1` |
| Date | `2026-08-23` |
| Status | `Draft` |
| Feature / Gap ID | `UC-MH-08` |
| Module | `Mother Journey and Health` |
| Paired TDS | `UC-MH-08-TDS` |
| Priority | `Medium` |
...
| Reviewer / Approver |  |
| Source Baseline | Current worktree `2026-08-23`; SRS/TDS `UC-MH-08` and exact code/test sources below |
...
| --- | --- | --- |
| Actor goal | Run a timed fetal-movement observation session and store the supported session result as a journey metric. | SRS `UC-MH-08` |
| Current state | `High` confidence; gaps are listed in Section 2 | Exact current code/test sources below |
| Entry points | Mobile metric add route with `metricType=FETAL_MOVEMENT_SESSION` | Current client/router evidence |
...
| Primary operations | Start a fetal-movement session for an eligible journey.; Record movements and the observation period.; Complete and persist the session observation. | SRS `UC-MH-08` Normal Flow |
...
| --- | --- | --- | --- | --- |
| `SRC-SRS` | Requirement | `02_Requirements/SRS/Report3_Functional_Specifications.md` — UC-MH-08 | 2026-08-23 | Draft code-first requirement |
| `SRC-TDS` | Design | Paired `UC-MH-08-TDS` | 0.1 | Draft design |
...
| --- | --- | --- | --- | --- | --- |
| `LI-01` | Broad 43-UC catalogue previously obscured this boundary | Generic TCs could not map to `Track Fetal Movement Sessions` | Split as `UC-MH-08` using the audited current code boundary | SRS 3.1 and `05_Development/CareBridgeAPI/src/main/java/com/carebridge/backend/health/controller/JourneyMetricController.java` | Resolved in Draft |
...
| --- | --- | --- | --- | --- | --- | --- |
| `RISK-01` | Failure of: Start a fetal-movement session for an eligible journey. | High | Medium | High | Unit/Integration/Contract/applicable UI | `COND-01` |
| `RISK-02` | Failure of: Record movements and the observation period. | High | Medium | High | Unit/Integration/Contract/applicable UI | `COND-02` |
| `RISK-03` | Failure of: Complete and persist the session observation. | High | Medium | High | Unit/Integration/Contract/applicable UI | `COND-03` |
...
| --- | --- | --- | --- | --- |
| `BASIS-01` | `UC-MH-08-FR-01` — Start a fetal-movement session for an eligible journey. | SRS `UC-MH-08` Normal Flow 1; TDS Section 2 | Start a fetal-movement session for an eligible journey. | `COND-01` |
| `BASIS-02` | `UC-MH-08-FR-02` — Record movements and the observation period. | SRS `UC-MH-08` Normal Flow 2; TDS Section 2 | Record movements and the observation period. | `COND-02` |
| `BASIS-03` | `UC-MH-08-FR-03` — Complete and persist the session observation. | SRS `UC-MH-08` Normal Flow 3; TDS Section 2 | Complete and persist the session observation. | `COND-03` |
...
| --- | --- | --- | --- | --- | --- |
| `COND-01` | `BASIS-01` / `RISK-01` | Start a fetal-movement session for an eligible journey. | Mobile / Backend | Positive + applicable boundary/state coverage | `UC-MH-08-TC-001` |
| `COND-02` | `BASIS-02` / `RISK-02` | Record movements and the observation period. | Mobile / Backend | Positive + applicable boundary/state coverage | `UC-MH-08-TC-002` |
| `COND-03` | `BASIS-03` / `RISK-03` | Complete and persist the session observation. | Mobile / Backend | Positive + applicable boundary/state coverage | `UC-MH-08-TC-003` |
| `COND-API-001` | Exact handler/client composition contract | GET /api/v1/journeys/{journeyId}/metrics → getMetricTrend contract | Applicable backend/client contract layer | Contract + DTO/status/authorization evidence | `UC-MH-08-TC-API-001` |
| `COND-API-002` | Exact handler/client composition contract | POST /api/v1/journeys/{journeyId}/metrics → addMetric contract | Applicable backend/client contract layer | Contract + DTO/status/authorization evidence | `UC-MH-08-TC-API-002` |
| `COND-API-002-VAL` | Exact handler/client composition contract | POST /api/v1/journeys/{journeyId}/metrics rejects a declared request-field boundary | Applicable backend/client contract layer | Contract + DTO/status/authorization evidence | `UC-MH-08-TC-API-002-VAL` |
| `COND-API-003` | Exact handler/client composition contract | GET /api/v1/journeys/{journeyId}/metrics/capabilities → getCapabilities contract | Applicable backend/client contract layer | Contract + DTO/status/authorization evidence | `UC-MH-08-TC-API-003` |
| `COND-API-004` | Exact handler/client composition contract | PUT /api/v1/journeys/{journeyId}/metrics/{metricId} → updateMetric contract | Applicable backend/client contract layer | Contract + DTO/status/authorization evidence | `UC-MH-08-TC-API-004` |
| `COND-API-004-VAL` | Exact handler/client composition contract | PUT /api/v1/journeys/{journeyId}/metrics/{metricId} rejects a declared request-field boundary | Applicable backend/client contract layer | Contract + DTO/status/authorization evidence | `UC-MH-08-TC-API-004-VAL` |
| `COND-BR-01` | `BR-01` | Period start/end and movement values follow server validation. | `05_Development/CareBridgeAPI/src/main/java/com/carebridge/backend/health/service/MetricObservationValidator.java` | Negative / decision / state | `UC-MH-08-TC-BR-001` |
| `COND-BR-02` | `BR-02` | This is tracking, not a diagnostic conclusion. | `05_Development/CareBridgeAPI/src/main/java/com/carebridge/backend/health/service/MetricObservationValidator.java` | Negative / decision / state | `UC-MH-08-TC-BR-002` |
| `COND-AUTH` | `RISK-AUTH` | Reject wrong authentication, role, ownership, membership, consent, or state scope | All protected layers | Security | `UC-MH-08-TC-SEC-001` |
| `COND-GAP` | `RISK-GAP` | Characterize current limitation/reachability without false completion | Applicable layer | Gap/Regression | `UC-MH-08-TC-GAP-001` |
...
### UC-MH-08-TC-001 — Start a fetal-movement session for an eligible journey

| Field | Specification |
| --- | --- |
| Stable ID | `UC-MH-08-TC-001` |
| Severity | `High` |
...
| Oracle Source | `SRS UC-MH-08 Normal Flow 1; 05_Development/CareBridgeAPI/src/main/java/com/carebridge/backend/health/controller/JourneyMetricController.java` |
| Preconditions | Synthetic `Mother` identity; eligible current resource state; isolated provider/database fixtures |
| Intended Test File | `05_Development/CareBridgeAPI/src/test/java/com/carebridge/backend/health/MetricObservationValidatorTest.java` |
...
1. Start a fetal-movement session for an eligible journey.

**Assert — observable result**

| Assertion area | Expected result | Oracle Source |
| --- | --- | --- |
| Response / return | The observable outcome is exactly `Start a fetal-movement session for an eligible journey.` The applicable handler, request/response type, status, and authorization evidence are those enumerated in paired TDS Sections 2, 9, 10, and 16; no additional state is claimed. | `SRS UC-MH-08 Normal Flow 1; 05_Development/CareBridgeAPI/src/main/java/com/carebridge/backend/health/controller/JourneyMetricController.java` |
...
| UI state | Reachable client displays the canonical outcome/error without false success. | SRS `UC-MH-08` entry point and current client evidence |
...
### UC-MH-08-TC-002 — Record movements and the observation period

| Field | Specification |
| --- | --- |
| Stable ID | `UC-MH-08-TC-002` |
| Severity | `High` |
| Test Condition | `COND-02` |
| Test Level | `Unit / Integration / Contract / applicable UI` |
| Platform / Layer | `Mobile / Backend` |
| Technique | `Requirement coverage + state/authorization partition as applicable` |
| Oracle Source | `SRS UC-MH-08 Normal Flow 2; 05_Development/CareBridgeAPI/src/main/java/com/carebridge/backend/health/controller/JourneyMetricController.java` |
| Preconditions | Synthetic `Mother` identity; eligible current resource state; isolated provider/database fixtures |
| Intended Test File | `05_Development/CareBridgeAPI/src/test/java/com/carebridge/backend/health/MetricObservationValidatorTest.java` |
| Initial Status | `🔴 Not written / existing evidence must be rerun` |
...
1. Record movements and the observation period.

**Assert — observable result**

| Assertion area | Expected result | Oracle Source |
| --- | --- | --- |
| Response / return | The observable outcome is exactly `Record movements and the observation period.` The applicable handler, request/response type, status, and authorization evidence are those enumerated in paired TDS Sections 2, 9, 10, and 16; no additional state is claimed. | `SRS UC-MH-08 Normal Flow 2; 05_Development/CareBridgeAPI/src/main/java/com/carebridge/backend/health/controller/JourneyMetricController.java` |
| Persistence | Only the state mutation required by this behavior occurs; read/rejection paths assert zero writes. | Paired TDS Sections 5–6 plus the exact handler/service oracle cited by this case; use repository state/spy evidence only when that call path mutates |
| Audit | Feature-owned audit entry only where current code defines it; otherwise `Not applicable — no audited mutation evidenced`. | Paired TDS Sections 7 and 10; current implementation source |
| Event / notification | Only an event/notification explicitly reachable from the cited call path; otherwise `Not applicable — no publisher/listener evidenced`. | Paired TDS Section 7 and current publisher/listener source when present |
| Provider side effect | Exact call count/payload only when the cited call path uses a provider; otherwise `Not applicable — no provider in this operation`. | Current adapter source cited by the paired TDS when present |
...
The contract differs from the cited expected result (The observable outcome is exactly `Record movements and the observation period.` The applicable handler, request/response type, status, and authorization evidence are those enumerated in paired TDS Sections 2, 9, 10, and 16; no additional state is claimed.), mutates data on a rejected/read path, leaks protected data, or triggers duplicate/unauthorized side effects.
...
### UC-MH-08-TC-003 — Complete and persist the session observation

| Field | Specification |
| --- | --- |
| Stable ID | `UC-MH-08-TC-003` |
| Severity | `High` |
| Test Condition | `COND-03` |
| Test Level | `Unit / Integration / Contract / applicable UI` |
| Platform / Layer | `Mobile / Backend` |
| Technique | `Requirement coverage + state/authorization partition as applicable` |
| Oracle Source | `SRS UC-MH-08 Normal Flow 3; 05_Development/CareBridgeAPI/src/main/java/com/carebridge/backend/health/controller/JourneyMetricController.java` |
| Preconditions | Synthetic `Mother` identity; eligible current resource state; isolated provider/database fixtures |
| Intended Test File | `05_Development/CareBridgeAPI/src/test/java/com/carebridge/backend/health/MetricObservationValidatorTest.java` |
| Initial Status | `🔴 Not written / existing evidence must be rerun` |
...
1. Complete and persist the session observation.

**Assert — observable result**

| Assertion area | Expected result | Oracle Source |
| --- | --- | --- |
| Response / return | The observable outcome is exactly `Complete and persist the session observation.` The applicable handler, request/response type, status, and authorization evidence are those enumerated in paired TDS Sections 2, 9, 10, and 16; no additional state is claimed. | `SRS UC-MH-08 Normal Flow 3; 05_Development/CareBridgeAPI/src/main/java/com/carebridge/backend/health/controller/JourneyMetricController.java` |
| Persistence | Only the state mutation required by this behavior occurs; read/rejection paths assert zero writes. | Paired TDS Sections 5–6 plus the exact handler/service oracle cited by this case; use repository state/spy evidence only when that call path mutates |
| Audit | Feature-owned audit entry only where current code defines it; otherwise `Not applicable — no audited mutation evidenced`. | Paired TDS Sections 7 and 10; current implementation source |
| Event / notification | Only an event/notification explicitly reachable from the cited call path; otherwise `Not applicable — no publisher/listener evidenced`. | Paired TDS Section 7 and current publisher/listener source when present |
| Provider side effect | Exact call count/payload only when the cited call path uses a provider; otherwise `Not applicable — no provider in this operation`. | Current adapter source cited by the paired TDS when present |
...
The contract differs from the cited expected result (The observable outcome is exactly `Complete and persist the session observation.` The applicable handler, request/response type, status, and authorization evidence are those enumerated in paired TDS Sections 2, 9, 10, and 16; no additional state is claimed.), mutates data on a rejected/read path, leaks protected data, or triggers duplicate/unauthorized side effects.
...
### UC-MH-08-TC-API-001 — GET /api/v1/journeys/{journeyId}/metrics → getMetricTrend contract

| Field | Specification |
| --- | --- |
| Stable ID | `UC-MH-08-TC-API-001` |
| Severity | `High` |
...
### UC-MH-08-TC-API-002 — POST /api/v1/journeys/{journeyId}/metrics → addMetric contract

| Field | Specification |
| --- | --- |
| Stable ID | `UC-MH-08-TC-API-002` |
| Severity | `High` |
...
### UC-MH-08-TC-API-002-VAL — POST /api/v1/journeys/{journeyId}/metrics rejects a declared request-field boundary

| Field | Specification |
| --- | --- |
| Stable ID | `UC-MH-08-TC-API-002-VAL` |
| Severity | `High` |
...
### UC-MH-08-TC-API-003 — GET /api/v1/journeys/{journeyId}/metrics/capabilities → getCapabilities contract

| Field | Specification |
| --- | --- |
| Stable ID | `UC-MH-08-TC-API-003` |
| Severity | `High` |
...
### UC-MH-08-TC-API-004 — PUT /api/v1/journeys/{journeyId}/metrics/{metricId} → updateMetric contract

| Field | Specification |
| --- | --- |
| Stable ID | `UC-MH-08-TC-API-004` |
| Severity | `High` |
...
### UC-MH-08-TC-API-004-VAL — PUT /api/v1/journeys/{journeyId}/metrics/{metricId} rejects a declared request-field boundary

| Field | Specification |
| --- | --- |
| Stable ID | `UC-MH-08-TC-API-004-VAL` |
| Severity | `High` |
...
### UC-MH-08-TC-BR-001 — Enforce business rule 1

| Field | Specification |
| --- | --- |
| Stable ID | `UC-MH-08-TC-BR-001` |
| Severity | `High` |
| Test Condition | `COND-BR-01` |
| Test Level | `Unit / Integration / Contract / applicable UI` |
| Platform / Layer | `Mobile / Backend` |
| Technique | `Requirement coverage + state/authorization partition as applicable` |
| Oracle Source | `TDS BR-01; 05_Development/CareBridgeAPI/src/main/java/com/carebridge/backend/health/service/MetricObservationValidator.java` |
| Preconditions | Synthetic `Mother` identity; eligible current resource state; isolated provider/database fixtures |
| Intended Test File | `05_Development/CareBridgeAPI/src/test/java/com/carebridge/backend/health/MetricObservationValidatorTest.java` |
| Initial Status | `🔴 Not written / existing evidence must be rerun` |
...
1. Exercise the eligible and ineligible partitions for this rule: Period start/end and movement values follow server validation.

**Assert — observable result**

| Assertion area | Expected result | Oracle Source |
| --- | --- | --- |
| Response / return | The server enforces: Period start/end and movement values follow server validation. No disallowed state or protected data is produced. | `TDS BR-01; 05_Development/CareBridgeAPI/src/main/java/com/carebridge/backend/health/service/MetricObservationValidator.java` |
| Persistence | Only the state mutation required by this behavior occurs; read/rejection paths assert zero writes. | Paired TDS Sections 5–6 plus the exact handler/service oracle cited by this case; use repository state/spy evidence only when that call path mutates |
| Audit | Feature-owned audit entry only where current code defines it; otherwise `Not applicable — no audited mutation evidenced`. | Paired TDS Sections 7 and 10; current implementation source |
| Event / notification | Only an event/notification explicitly reachable from the cited call path; otherwise `Not applicable — no publisher/listener evidenced`. | Paired TDS Section 7 and current publisher/listener source when present |
| Provider side effect | Exact call count/payload only when the cited call path uses a provider; otherwise `Not applicable — no provider in this operation`. | Current adapter source cited by the paired TDS when present |
...
The contract differs from the cited expected result (The server enforces: Period start/end and movement values follow server validation. No disallowed state or protected data is produced.), mutates data on a rejected/read path, leaks protected data, or triggers duplicate/unauthorized side effects.
...
### UC-MH-08-TC-BR-002 — Enforce business rule 2

| Field | Specification |
| --- | --- |
| Stable ID | `UC-MH-08-TC-BR-002` |
| Severity | `High` |
| Test Condition | `COND-BR-02` |
| Test Level | `Unit / Integration / Contract / applicable UI` |
| Platform / Layer | `Mobile / Backend` |
| Technique | `Requirement coverage + state/authorization partition as applicable` |
| Oracle Source | `TDS BR-02; 05_Development/CareBridgeAPI/src/main/java/com/carebridge/backend/health/service/MetricObservationValidator.java` |
| Preconditions | Synthetic `Mother` identity; eligible current resource state; isolated provider/database fixtures |
| Intended Test File | `05_Development/CareBridgeAPI/src/test/java/com/carebridge/backend/health/MetricObservationValidatorTest.java` |
| Initial Status | `🔴 Not written / existing evidence must be rerun` |
...
1. Exercise the eligible and ineligible partitions for this rule: This is tracking, not a diagnostic conclusion.

**Assert — observable result**

| Assertion area | Expected result | Oracle Source |
| --- | --- | --- |
| Response / return | The server enforces: This is tracking, not a diagnostic conclusion. No disallowed state or protected data is produced. | `TDS BR-02; 05_Development/CareBridgeAPI/src/main/java/com/carebridge/backend/health/service/MetricObservationValidator.java` |
| Persistence | Only the state mutation required by this behavior occurs; read/rejection paths assert zero writes. | Paired TDS Sections 5–6 plus the exact handler/service oracle cited by this case; use repository state/spy evidence only when that call path mutates |
| Audit | Feature-owned audit entry only where current code defines it; otherwise `Not applicable — no audited mutation evidenced`. | Paired TDS Sections 7 and 10; current implementation source |
| Event / notification | Only an event/notification explicitly reachable from the cited call path; otherwise `Not applicable — no publisher/listener evidenced`. | Paired TDS Section 7 and current publisher/listener source when present |
| Provider side effect | Exact call count/payload only when the cited call path uses a provider; otherwise `Not applicable — no provider in this operation`. | Current adapter source cited by the paired TDS when present |
...
The contract differs from the cited expected result (The server enforces: This is tracking, not a diagnostic conclusion. No disallowed state or protected data is produced.), mutates data on a rejected/read path, leaks protected data, or triggers duplicate/unauthorized side effects.
...
### UC-MH-08-TC-SEC-001 — Reject wrong authentication, role, ownership, membership, or consent scope

| Field | Specification |
| --- | --- |
| Stable ID | `UC-MH-08-TC-SEC-001` |
| Severity | `Critical` |
...
### UC-MH-08-TC-GAP-001 — Prove the current actor entry path and owning contract remain reachable

| Field | Specification |
| --- | --- |
| Stable ID | `UC-MH-08-TC-GAP-001` |
| Severity | `Medium` |
| Test Condition | `COND-GAP` |
| Test Level | `Unit / Integration / Contract / applicable UI` |
| Platform / Layer | `Mobile / Backend` |
| Technique | `Requirement coverage + state/authorization partition as applicable` |
| Oracle Source | `SRS UC-MH-08 Implemented Entry Points/Contracts; 05_Development/CareBridgeMobileApp/lib/features/healthRecords/screens/fetal_movement_tracker_screen.dart` |
| Preconditions | Synthetic `Mother` identity; eligible current resource state; isolated provider/database fixtures |
| Intended Test File | `05_Development/CareBridgeAPI/src/test/java/com/carebridge/backend/health/MetricObservationValidatorTest.java` |
| Initial Status | `🔴 Not written / existing evidence must be rerun` |
...
1. Start from `Mobile metric add route with `metricType=FETAL_MOVEMENT_SESSION``, perform `Start a fetal-movement session for an eligible journey.`, and observe the owning contract `GET/POST/PUT `/api/v1/journeys/{journeyId}/metrics/**`` rather than a retired or unrelated route.

**Assert — observable result**

| Assertion area | Expected result | Oracle Source |
| --- | --- | --- |
| Response / return | The current entry path remains reachable for `Track Fetal Movement Sessions` and invokes only the documented owning contract; an unreachable, static, or wrong-method path fails this case. | `SRS UC-MH-08 Implemented Entry Points/Contracts; 05_Development/CareBridgeMobileApp/lib/features/healthRecords/screens/fetal_movement_tracker_screen.dart` |
| Persistence | Only the state mutation required by this behavior occurs; read/rejection paths assert zero writes. | Paired TDS Sections 5–6 plus the exact handler/service oracle cited by this case; use repository state/spy evidence only when that call path mutates |
| Audit | Feature-owned audit entry only where current code defines it; otherwise `Not applicable — no audited mutation evidenced`. | Paired TDS Sections 7 and 10; current implementation source |
| Event / notification | Only an event/notification explicitly reachable from the cited call path; otherwise `Not applicable — no publisher/listener evidenced`. | Paired TDS Section 7 and current publisher/listener source when present |
| Provider side effect | Exact call count/payload only when the cited call path uses a provider; otherwise `Not applicable — no provider in this operation`. | Current adapter source cited by the paired TDS when present |
...
The contract differs from the cited expected result (The current entry path remains reachable for `Track Fetal Movement Sessions` and invokes only the documented owning contract; an unreachable, static, or wrong-method path fails this case.), mutates data on a rejected/read path, leaks protected data, or triggers duplicate/unauthorized side effects.
...
| --- | --- | --- |
| Start a fetal-movement session for an eligible journey. | `COND-01` | `UC-MH-08-TC-001` |
| Record movements and the observation period. | `COND-02` | `UC-MH-08-TC-002` |
| Complete and persist the session observation. | `COND-03` | `UC-MH-08-TC-003` |
| GET /api/v1/journeys/{journeyId}/metrics → getMetricTrend contract | `COND-API-001` | `UC-MH-08-TC-API-001` |
| POST /api/v1/journeys/{journeyId}/metrics → addMetric contract | `COND-API-002` | `UC-MH-08-TC-API-002` |
| POST /api/v1/journeys/{journeyId}/metrics rejects a declared request-field boundary | `COND-API-002-VAL` | `UC-MH-08-TC-API-002-VAL` |
| GET /api/v1/journeys/{journeyId}/metrics/capabilities → getCapabilities contract | `COND-API-003` | `UC-MH-08-TC-API-003` |
| PUT /api/v1/journeys/{journeyId}/metrics/{metricId} → updateMetric contract | `COND-API-004` | `UC-MH-08-TC-API-004` |
| PUT /api/v1/journeys/{journeyId}/metrics/{metricId} rejects a declared request-field boundary | `COND-API-004-VAL` | `UC-MH-08-TC-API-004-VAL` |
| Business-rule partitions | `COND-BR-*` | `UC-MH-08-TC-BR-*` |
| Authentication / authorization / ownership / consent | `COND-AUTH` | `UC-MH-08-TC-SEC-001` |
| Current gap / reachability boundary | `COND-GAP` | `UC-MH-08-TC-GAP-001` |

## 5. Red-Green-Refactor Tracker

| TC ID | Intended file | Red evidence | Green evidence | Refactor verification | Status |
| --- | --- | --- | --- | --- | --- |
| `UC-MH-08-TC-001` | `05_Development/CareBridgeAPI/src/test/java/com/carebridge/backend/health/MetricObservationValidatorTest.java` | Not run | Not run | Not run | 🔴 Not written / rerun required |
| `UC-MH-08-TC-002` | `05_Development/CareBridgeAPI/src/test/java/com/carebridge/backend/health/MetricObservationValidatorTest.java` | Not run | Not run | Not run | 🔴 Not written / rerun required |
| `UC-MH-08-TC-003` | `05_Development/CareBridgeAPI/src/test/java/com/carebridge/backend/health/MetricObservationValidatorTest.java` | Not run | Not run | Not run | 🔴 Not written / rerun required |
| `UC-MH-08-TC-API-001` | Planned — `05_Development/CareBridgeAPI/src/test/java/com/carebridge/backend/health/controller/JourneyMetricControllerTest.java` (not present at Draft baseline) | Not run | Not run | Not run | 🔴 Not written / rerun required |
| `UC-MH-08-TC-API-002` | Planned — `05_Development/CareBridgeAPI/src/test/java/com/carebridge/backend/health/controller/JourneyMetricControllerTest.java` (not present at Draft baseline) | Not run | Not run | Not run | 🔴 Not written / rerun required |
| `UC-MH-08-TC-API-002-VAL` | Planned — `05_Development/CareBridgeAPI/src/test/java/com/carebridge/backend/health/controller/JourneyMetricControllerTest.java` (not present at Draft baseline) | Not run | Not run | Not run | 🔴 Not written / rerun required |
| `UC-MH-08-TC-API-003` | Planned — `05_Development/CareBridgeAPI/src/test/java/com/carebridge/backend/health/controller/JourneyMetricControllerTest.java` (not present at Draft baseline) | Not run | Not run | Not run | 🔴 Not written / rerun required |
| `UC-MH-08-TC-API-004` | Planned — `05_Development/CareBridgeAPI/src/test/java/com/carebridge/backend/health/controller/JourneyMetricControllerTest.java` (not present at Draft baseline) | Not run | Not run | Not run | 🔴 Not written / rerun required |
| `UC-MH-08-TC-API-004-VAL` | Planned — `05_Development/CareBridgeAPI/src/test/java/com/carebridge/backend/health/controller/JourneyMetricControllerTest.java` (not present at Draft baseline) | Not run | Not run | Not run | 🔴 Not written / rerun required |
| `UC-MH-08-TC-BR-001` | `05_Development/CareBridgeAPI/src/test/java/com/carebridge/backend/health/MetricObservationValidatorTest.java` | Not run | Not run | Not run | 🔴 Not written / rerun required |
| `UC-MH-08-TC-BR-002` | `05_Development/CareBridgeAPI/src/test/java/com/carebridge/backend/health/MetricObservationValidatorTest.java` | Not run | Not run | Not run | 🔴 Not written / rerun required |
| `UC-MH-08-TC-SEC-001` | `05_Development/CareBridgeAPI/src/test/java/com/carebridge/backend/health/MetricObservationValidatorTest.java` | Not run | Not run | Not run | 🔴 Not written / rerun required |
| `UC-MH-08-TC-GAP-001` | `05_Development/CareBridgeAPI/src/test/java/com/carebridge/backend/health/MetricObservationValidatorTest.java` | Not run | Not run | Not run | 🔴 Not written / rerun required |
...
| Generic test matrix | Case titles/actions reference `Track Fetal Movement Sessions` operations and rules. | Pass |
