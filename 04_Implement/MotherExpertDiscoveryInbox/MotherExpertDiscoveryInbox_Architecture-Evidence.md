> [!IMPORTANT]
> Historical cross-UC evidence for `UC-EX-07` and `UC-EX-10`; this is not a canonical current TDS. Current code and the canonical code-first specifications override conflicts.
