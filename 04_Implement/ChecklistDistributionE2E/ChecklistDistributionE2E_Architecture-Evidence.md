> [!IMPORTANT]
> Historical cross-UC evidence for `UC-AD-10`, `UC-AD-11`, and `UC-MH-17`; this is not a canonical current TDS. Current code and the canonical code-first specifications override conflicts.
