...
| `2026-07-26` | `AI Agent — Amelia (Dev Agent)` | Phase 3 Deviation D1: empty context keeps legacy one-arg AI/fallback calls (wire-identical; keeps TriageRedFlagPreScreenIntegrationTest green) — TC-09/13/15 assertions updated; re-run green |
