> [!IMPORTANT]
> Historical cross-UC verification evidence for `UC-MH-10` and `UC-AC-08`; this is not a canonical current Test-Spec. Current code and the canonical code-first specifications override conflicts.
...
**References:**
- `04_Implement/EpdsFamilyNotification/EpdsFamilyNotification_Architecture-Evidence.md` (`CB-EPDS-IMP-001`) — primary oracle
