> [!IMPORTANT]
> Historical cross-UC evidence for `UC-MH-10` and `UC-AC-08`; this is not a canonical current TDS. Current code and the canonical code-first specifications override conflicts.
...
Detailed cases live in `EpdsFamilyNotification_Verification-Evidence.md`; this section defines strategy only.
...
tests; that is tracked in `EpdsFamilyNotification_Verification-Evidence.md` §8.
