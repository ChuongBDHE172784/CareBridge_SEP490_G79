...
# TEST SPECIFICATION — Track Hydration

| Field | Value |
| --- | --- |
| Document ID | `UC-MH-09-TEST-SPEC` |
| Version | `0.1` |
| Date | `2026-08-23` |
| Status | `Draft` |
| Feature / Gap ID | `UC-MH-09` |
| Module | `Mother Journey and Health` |
| Paired TDS | `UC-MH-09-TDS` |
| Priority | `Medium` |
...
| Reviewer / Approver |  |
| Source Baseline | Current worktree `2026-08-23`; SRS/TDS `UC-MH-09` and exact code/test sources below |
...
| --- | --- | --- |
| Actor goal | Record hydration intake through the dedicated tracker and persist the corresponding journey metric. | SRS `UC-MH-09` |
| Current state | `Medium` confidence; gaps are listed in Section 2 | Exact current code/test sources below |
| Entry points | Mobile metric add route with `metricType=HYDRATION` | Current client/router evidence |
...
| Primary operations | Open hydration tracking for an eligible journey.; Add or adjust the supported intake amount.; Persist and refresh hydration progress. | SRS `UC-MH-09` Normal Flow |
...
| --- | --- | --- | --- | --- |
| `SRC-SRS` | Requirement | `02_Requirements/SRS/Report3_Functional_Specifications.md` — UC-MH-09 | 2026-08-23 | Draft code-first requirement |
| `SRC-TDS` | Design | Paired `UC-MH-09-TDS` | 0.1 | Draft design |
...
| `SRC-CODE-02` | Current code | `05_Development/CareBridgeMobileApp/lib/features/healthRecords/screens/hydration_tracker_screen.dart` | Worktree `2026-08-23` | Current-state evidence |
...
| --- | --- | --- | --- | --- | --- |
| `LI-01` | No focused hydration-screen test was found. | Could create false completed coverage or wrong contract | Keep as current limitation/Open until the cited client/server mismatch is resolved | SRS `UC-MH-09` gap plus current code | Open |
...
| --- | --- | --- | --- | --- | --- | --- |
| `RISK-01` | Failure of: Open hydration tracking for an eligible journey. | High | Medium | High | Unit/Integration/Contract/applicable UI | `COND-01` |
| `RISK-02` | Failure of: Add or adjust the supported intake amount. | High | Medium | High | Unit/Integration/Contract/applicable UI | `COND-02` |
| `RISK-03` | Failure of: Persist and refresh hydration progress. | High | Medium | High | Unit/Integration/Contract/applicable UI | `COND-03` |
...
| --- | --- | --- | --- | --- |
| `BASIS-01` | `UC-MH-09-FR-01` — Open hydration tracking for an eligible journey. | SRS `UC-MH-09` Normal Flow 1; TDS Section 2 | Open hydration tracking for an eligible journey. | `COND-01` |
| `BASIS-02` | `UC-MH-09-FR-02` — Add or adjust the supported intake amount. | SRS `UC-MH-09` Normal Flow 2; TDS Section 2 | Add or adjust the supported intake amount. | `COND-02` |
| `BASIS-03` | `UC-MH-09-FR-03` — Persist and refresh hydration progress. | SRS `UC-MH-09` Normal Flow 3; TDS Section 2 | Persist and refresh hydration progress. | `COND-03` |
...
| --- | --- | --- | --- | --- | --- |
| `COND-01` | `BASIS-01` / `RISK-01` | Open hydration tracking for an eligible journey. | Mobile / Backend | Positive + applicable boundary/state coverage | `UC-MH-09-TC-001` |
| `COND-02` | `BASIS-02` / `RISK-02` | Add or adjust the supported intake amount. | Mobile / Backend | Positive + applicable boundary/state coverage | `UC-MH-09-TC-002` |
| `COND-03` | `BASIS-03` / `RISK-03` | Persist and refresh hydration progress. | Mobile / Backend | Positive + applicable boundary/state coverage | `UC-MH-09-TC-003` |
| `COND-API-001` | Exact handler/client composition contract | GET /api/v1/journeys/{journeyId}/metrics → getMetricTrend contract | Applicable backend/client contract layer | Contract + DTO/status/authorization evidence | `UC-MH-09-TC-API-001` |
| `COND-API-002` | Exact handler/client composition contract | POST /api/v1/journeys/{journeyId}/metrics → addMetric contract | Applicable backend/client contract layer | Contract + DTO/status/authorization evidence | `UC-MH-09-TC-API-002` |
| `COND-API-002-VAL` | Exact handler/client composition contract | POST /api/v1/journeys/{journeyId}/metrics rejects a declared request-field boundary | Applicable backend/client contract layer | Contract + DTO/status/authorization evidence | `UC-MH-09-TC-API-002-VAL` |
| `COND-API-003` | Exact handler/client composition contract | GET /api/v1/journeys/{journeyId}/metrics/capabilities → getCapabilities contract | Applicable backend/client contract layer | Contract + DTO/status/authorization evidence | `UC-MH-09-TC-API-003` |
| `COND-API-004` | Exact handler/client composition contract | PUT /api/v1/journeys/{journeyId}/metrics/{metricId} → updateMetric contract | Applicable backend/client contract layer | Contract + DTO/status/authorization evidence | `UC-MH-09-TC-API-004` |
| `COND-API-004-VAL` | Exact handler/client composition contract | PUT /api/v1/journeys/{journeyId}/metrics/{metricId} rejects a declared request-field boundary | Applicable backend/client contract layer | Contract + DTO/status/authorization evidence | `UC-MH-09-TC-API-004-VAL` |
| `COND-BR-01` | `BR-01` | Amount/unit/range validation is server authoritative. | `05_Development/CareBridgeAPI/src/main/java/com/carebridge/backend/health/controller/JourneyMetricController.java` | Negative / decision / state | `UC-MH-09-TC-BR-001` |
| `COND-BR-02` | `BR-02` | Hydration tracking does not diagnose dehydration. | `05_Development/CareBridgeAPI/src/main/java/com/carebridge/backend/health/controller/JourneyMetricController.java` | Negative / decision / state | `UC-MH-09-TC-BR-002` |
| `COND-AUTH` | `RISK-AUTH` | Reject wrong authentication, role, ownership, membership, consent, or state scope | All protected layers | Security | `UC-MH-09-TC-SEC-001` |
| `COND-GAP` | `RISK-GAP` | Characterize current limitation/reachability without false completion | Applicable layer | Gap/Regression | `UC-MH-09-TC-GAP-001` |
...
### UC-MH-09-TC-001 — Open hydration tracking for an eligible journey

| Field | Specification |
| --- | --- |
| Stable ID | `UC-MH-09-TC-001` |
| Severity | `High` |
...
| Oracle Source | `SRS UC-MH-09 Normal Flow 1; 05_Development/CareBridgeAPI/src/main/java/com/carebridge/backend/health/controller/JourneyMetricController.java` |
...
1. Open hydration tracking for an eligible journey.

**Assert — observable result**

| Assertion area | Expected result | Oracle Source |
| --- | --- | --- |
| Response / return | The observable outcome is exactly `Open hydration tracking for an eligible journey.` The applicable handler, request/response type, status, and authorization evidence are those enumerated in paired TDS Sections 2, 9, 10, and 16; no additional state is claimed. | `SRS UC-MH-09 Normal Flow 1; 05_Development/CareBridgeAPI/src/main/java/com/carebridge/backend/health/controller/JourneyMetricController.java` |
...
| UI state | Reachable client displays the canonical outcome/error without false success. | SRS `UC-MH-09` entry point and current client evidence |
...
### UC-MH-09-TC-002 — Add or adjust the supported intake amount

| Field | Specification |
| --- | --- |
| Stable ID | `UC-MH-09-TC-002` |
| Severity | `High` |
| Test Condition | `COND-02` |
| Test Level | `Unit / Integration / Contract / applicable UI` |
| Platform / Layer | `Mobile / Backend` |
| Technique | `Requirement coverage + state/authorization partition as applicable` |
| Oracle Source | `SRS UC-MH-09 Normal Flow 2; 05_Development/CareBridgeAPI/src/main/java/com/carebridge/backend/health/controller/JourneyMetricController.java` |
| Preconditions | Synthetic `Mother` identity; eligible current resource state; isolated provider/database fixtures |
| Intended Test File | `05_Development/CareBridgeAPI/src/test/java/com/carebridge/backend/health/MetricObservationValidatorTest.java` |
| Initial Status | `🔴 Not written / existing evidence must be rerun` |
...
1. Add or adjust the supported intake amount.

**Assert — observable result**

| Assertion area | Expected result | Oracle Source |
| --- | --- | --- |
| Response / return | The observable outcome is exactly `Add or adjust the supported intake amount.` The applicable handler, request/response type, status, and authorization evidence are those enumerated in paired TDS Sections 2, 9, 10, and 16; no additional state is claimed. | `SRS UC-MH-09 Normal Flow 2; 05_Development/CareBridgeAPI/src/main/java/com/carebridge/backend/health/controller/JourneyMetricController.java` |
| Persistence | Only the state mutation required by this behavior occurs; read/rejection paths assert zero writes. | Paired TDS Sections 5–6 plus the exact handler/service oracle cited by this case; use repository state/spy evidence only when that call path mutates |
| Audit | Feature-owned audit entry only where current code defines it; otherwise `Not applicable — no audited mutation evidenced`. | Paired TDS Sections 7 and 10; current implementation source |
| Event / notification | Only an event/notification explicitly reachable from the cited call path; otherwise `Not applicable — no publisher/listener evidenced`. | Paired TDS Section 7 and current publisher/listener source when present |
| Provider side effect | Exact call count/payload only when the cited call path uses a provider; otherwise `Not applicable — no provider in this operation`. | Current adapter source cited by the paired TDS when present |
...
The contract differs from the cited expected result (The observable outcome is exactly `Add or adjust the supported intake amount.` The applicable handler, request/response type, status, and authorization evidence are those enumerated in paired TDS Sections 2, 9, 10, and 16; no additional state is claimed.), mutates data on a rejected/read path, leaks protected data, or triggers duplicate/unauthorized side effects.
...
### UC-MH-09-TC-003 — Persist and refresh hydration progress

| Field | Specification |
| --- | --- |
| Stable ID | `UC-MH-09-TC-003` |
| Severity | `High` |
| Test Condition | `COND-03` |
| Test Level | `Unit / Integration / Contract / applicable UI` |
| Platform / Layer | `Mobile / Backend` |
| Technique | `Requirement coverage + state/authorization partition as applicable` |
| Oracle Source | `SRS UC-MH-09 Normal Flow 3; 05_Development/CareBridgeAPI/src/main/java/com/carebridge/backend/health/controller/JourneyMetricController.java` |
| Preconditions | Synthetic `Mother` identity; eligible current resource state; isolated provider/database fixtures |
| Intended Test File | `05_Development/CareBridgeAPI/src/test/java/com/carebridge/backend/health/MetricObservationValidatorTest.java` |
| Initial Status | `🔴 Not written / existing evidence must be rerun` |
...
1. Persist and refresh hydration progress.

**Assert — observable result**

| Assertion area | Expected result | Oracle Source |
| --- | --- | --- |
| Response / return | The observable outcome is exactly `Persist and refresh hydration progress.` The applicable handler, request/response type, status, and authorization evidence are those enumerated in paired TDS Sections 2, 9, 10, and 16; no additional state is claimed. | `SRS UC-MH-09 Normal Flow 3; 05_Development/CareBridgeAPI/src/main/java/com/carebridge/backend/health/controller/JourneyMetricController.java` |
| Persistence | Only the state mutation required by this behavior occurs; read/rejection paths assert zero writes. | Paired TDS Sections 5–6 plus the exact handler/service oracle cited by this case; use repository state/spy evidence only when that call path mutates |
| Audit | Feature-owned audit entry only where current code defines it; otherwise `Not applicable — no audited mutation evidenced`. | Paired TDS Sections 7 and 10; current implementation source |
| Event / notification | Only an event/notification explicitly reachable from the cited call path; otherwise `Not applicable — no publisher/listener evidenced`. | Paired TDS Section 7 and current publisher/listener source when present |
| Provider side effect | Exact call count/payload only when the cited call path uses a provider; otherwise `Not applicable — no provider in this operation`. | Current adapter source cited by the paired TDS when present |
...
The contract differs from the cited expected result (The observable outcome is exactly `Persist and refresh hydration progress.` The applicable handler, request/response type, status, and authorization evidence are those enumerated in paired TDS Sections 2, 9, 10, and 16; no additional state is claimed.), mutates data on a rejected/read path, leaks protected data, or triggers duplicate/unauthorized side effects.
...
### UC-MH-09-TC-API-001 — GET /api/v1/journeys/{journeyId}/metrics → getMetricTrend contract

| Field | Specification |
| --- | --- |
| Stable ID | `UC-MH-09-TC-API-001` |
| Severity | `High` |
...
### UC-MH-09-TC-API-002 — POST /api/v1/journeys/{journeyId}/metrics → addMetric contract

| Field | Specification |
| --- | --- |
| Stable ID | `UC-MH-09-TC-API-002` |
| Severity | `High` |
...
### UC-MH-09-TC-API-002-VAL — POST /api/v1/journeys/{journeyId}/metrics rejects a declared request-field boundary

| Field | Specification |
| --- | --- |
| Stable ID | `UC-MH-09-TC-API-002-VAL` |
| Severity | `High` |
...
### UC-MH-09-TC-API-003 — GET /api/v1/journeys/{journeyId}/metrics/capabilities → getCapabilities contract

| Field | Specification |
| --- | --- |
| Stable ID | `UC-MH-09-TC-API-003` |
| Severity | `High` |
...
### UC-MH-09-TC-API-004 — PUT /api/v1/journeys/{journeyId}/metrics/{metricId} → updateMetric contract

| Field | Specification |
| --- | --- |
| Stable ID | `UC-MH-09-TC-API-004` |
| Severity | `High` |
...
### UC-MH-09-TC-API-004-VAL — PUT /api/v1/journeys/{journeyId}/metrics/{metricId} rejects a declared request-field boundary

| Field | Specification |
| --- | --- |
| Stable ID | `UC-MH-09-TC-API-004-VAL` |
| Severity | `High` |
...
### UC-MH-09-TC-BR-001 — Enforce business rule 1

| Field | Specification |
| --- | --- |
| Stable ID | `UC-MH-09-TC-BR-001` |
| Severity | `High` |
| Test Condition | `COND-BR-01` |
| Test Level | `Unit / Integration / Contract / applicable UI` |
| Platform / Layer | `Mobile / Backend` |
| Technique | `Requirement coverage + state/authorization partition as applicable` |
| Oracle Source | `TDS BR-01; 05_Development/CareBridgeAPI/src/main/java/com/carebridge/backend/health/controller/JourneyMetricController.java` |
| Preconditions | Synthetic `Mother` identity; eligible current resource state; isolated provider/database fixtures |
| Intended Test File | `05_Development/CareBridgeAPI/src/test/java/com/carebridge/backend/health/MetricObservationValidatorTest.java` |
| Initial Status | `🔴 Not written / existing evidence must be rerun` |
...
1. Exercise the eligible and ineligible partitions for this rule: Amount/unit/range validation is server authoritative.

**Assert — observable result**

| Assertion area | Expected result | Oracle Source |
| --- | --- | --- |
| Response / return | The server enforces: Amount/unit/range validation is server authoritative. No disallowed state or protected data is produced. | `TDS BR-01; 05_Development/CareBridgeAPI/src/main/java/com/carebridge/backend/health/controller/JourneyMetricController.java` |
| Persistence | Only the state mutation required by this behavior occurs; read/rejection paths assert zero writes. | Paired TDS Sections 5–6 plus the exact handler/service oracle cited by this case; use repository state/spy evidence only when that call path mutates |
| Audit | Feature-owned audit entry only where current code defines it; otherwise `Not applicable — no audited mutation evidenced`. | Paired TDS Sections 7 and 10; current implementation source |
| Event / notification | Only an event/notification explicitly reachable from the cited call path; otherwise `Not applicable — no publisher/listener evidenced`. | Paired TDS Section 7 and current publisher/listener source when present |
| Provider side effect | Exact call count/payload only when the cited call path uses a provider; otherwise `Not applicable — no provider in this operation`. | Current adapter source cited by the paired TDS when present |
...
The contract differs from the cited expected result (The server enforces: Amount/unit/range validation is server authoritative. No disallowed state or protected data is produced.), mutates data on a rejected/read path, leaks protected data, or triggers duplicate/unauthorized side effects.
...
### UC-MH-09-TC-BR-002 — Enforce business rule 2

| Field | Specification |
| --- | --- |
| Stable ID | `UC-MH-09-TC-BR-002` |
| Severity | `High` |
...
1. Exercise the eligible and ineligible partitions for this rule: Hydration tracking does not diagnose dehydration.

**Assert — observable result**

| Assertion area | Expected result | Oracle Source |
| --- | --- | --- |
| Response / return | The server enforces: Hydration tracking does not diagnose dehydration. No disallowed state or protected data is produced. | `TDS BR-02; 05_Development/CareBridgeAPI/src/main/java/com/carebridge/backend/health/controller/JourneyMetricController.java` |
| Persistence | Only the state mutation required by this behavior occurs; read/rejection paths assert zero writes. | Paired TDS Sections 5–6 plus the exact handler/service oracle cited by this case; use repository state/spy evidence only when that call path mutates |
| Audit | Feature-owned audit entry only where current code defines it; otherwise `Not applicable — no audited mutation evidenced`. | Paired TDS Sections 7 and 10; current implementation source |
| Event / notification | Only an event/notification explicitly reachable from the cited call path; otherwise `Not applicable — no publisher/listener evidenced`. | Paired TDS Section 7 and current publisher/listener source when present |
| Provider side effect | Exact call count/payload only when the cited call path uses a provider; otherwise `Not applicable — no provider in this operation`. | Current adapter source cited by the paired TDS when present |
...
The contract differs from the cited expected result (The server enforces: Hydration tracking does not diagnose dehydration. No disallowed state or protected data is produced.), mutates data on a rejected/read path, leaks protected data, or triggers duplicate/unauthorized side effects.
...
### UC-MH-09-TC-SEC-001 — Reject wrong authentication, role, ownership, membership, or consent scope

| Field | Specification |
| --- | --- |
| Stable ID | `UC-MH-09-TC-SEC-001` |
| Severity | `Critical` |
...
### UC-MH-09-TC-GAP-001 — Characterize the current documented limitation

| Field | Specification |
| --- | --- |
| Stable ID | `UC-MH-09-TC-GAP-001` |
| Severity | `High` |
| Test Condition | `COND-GAP` |
| Test Level | `Unit / Integration / Contract / applicable UI` |
| Platform / Layer | `Mobile / Backend` |
| Technique | `Requirement coverage + state/authorization partition as applicable` |
| Oracle Source | `SRS UC-MH-09 Known Gaps / Exclusions; 05_Development/CareBridgeAPI/src/main/java/com/carebridge/backend/health/controller/JourneyMetricController.java` |
| Preconditions | Synthetic `Mother` identity; eligible current resource state; isolated provider/database fixtures |
| Intended Test File | `05_Development/CareBridgeAPI/src/test/java/com/carebridge/backend/health/MetricObservationValidatorTest.java` |
| Initial Status | `🔴 Not written / existing evidence must be rerun` |
...
1. No focused hydration-screen test was found.

**Assert — observable result**

| Assertion area | Expected result | Oracle Source |
| --- | --- | --- |
| Response / return | The test records the current limitation without inventing a completed path: No focused hydration-screen test was found. | `SRS UC-MH-09 Known Gaps / Exclusions; 05_Development/CareBridgeAPI/src/main/java/com/carebridge/backend/health/controller/JourneyMetricController.java` |
| Persistence | Only the state mutation required by this behavior occurs; read/rejection paths assert zero writes. | Paired TDS Sections 5–6 plus the exact handler/service oracle cited by this case; use repository state/spy evidence only when that call path mutates |
| Audit | Feature-owned audit entry only where current code defines it; otherwise `Not applicable — no audited mutation evidenced`. | Paired TDS Sections 7 and 10; current implementation source |
| Event / notification | Only an event/notification explicitly reachable from the cited call path; otherwise `Not applicable — no publisher/listener evidenced`. | Paired TDS Section 7 and current publisher/listener source when present |
| Provider side effect | Exact call count/payload only when the cited call path uses a provider; otherwise `Not applicable — no provider in this operation`. | Current adapter source cited by the paired TDS when present |
...
The contract differs from the cited expected result (The test records the current limitation without inventing a completed path: No focused hydration-screen test was found.), mutates data on a rejected/read path, leaks protected data, or triggers duplicate/unauthorized side effects.
...
| --- | --- | --- |
| Open hydration tracking for an eligible journey. | `COND-01` | `UC-MH-09-TC-001` |
| Add or adjust the supported intake amount. | `COND-02` | `UC-MH-09-TC-002` |
| Persist and refresh hydration progress. | `COND-03` | `UC-MH-09-TC-003` |
| GET /api/v1/journeys/{journeyId}/metrics → getMetricTrend contract | `COND-API-001` | `UC-MH-09-TC-API-001` |
| POST /api/v1/journeys/{journeyId}/metrics → addMetric contract | `COND-API-002` | `UC-MH-09-TC-API-002` |
| POST /api/v1/journeys/{journeyId}/metrics rejects a declared request-field boundary | `COND-API-002-VAL` | `UC-MH-09-TC-API-002-VAL` |
| GET /api/v1/journeys/{journeyId}/metrics/capabilities → getCapabilities contract | `COND-API-003` | `UC-MH-09-TC-API-003` |
| PUT /api/v1/journeys/{journeyId}/metrics/{metricId} → updateMetric contract | `COND-API-004` | `UC-MH-09-TC-API-004` |
| PUT /api/v1/journeys/{journeyId}/metrics/{metricId} rejects a declared request-field boundary | `COND-API-004-VAL` | `UC-MH-09-TC-API-004-VAL` |
| Business-rule partitions | `COND-BR-*` | `UC-MH-09-TC-BR-*` |
| Authentication / authorization / ownership / consent | `COND-AUTH` | `UC-MH-09-TC-SEC-001` |
| Current gap / reachability boundary | `COND-GAP` | `UC-MH-09-TC-GAP-001` |

## 5. Red-Green-Refactor Tracker

| TC ID | Intended file | Red evidence | Green evidence | Refactor verification | Status |
| --- | --- | --- | --- | --- | --- |
| `UC-MH-09-TC-001` | `05_Development/CareBridgeAPI/src/test/java/com/carebridge/backend/health/MetricObservationValidatorTest.java` | Not run | Not run | Not run | 🔴 Not written / rerun required |
| `UC-MH-09-TC-002` | `05_Development/CareBridgeAPI/src/test/java/com/carebridge/backend/health/MetricObservationValidatorTest.java` | Not run | Not run | Not run | 🔴 Not written / rerun required |
| `UC-MH-09-TC-003` | `05_Development/CareBridgeAPI/src/test/java/com/carebridge/backend/health/MetricObservationValidatorTest.java` | Not run | Not run | Not run | 🔴 Not written / rerun required |
| `UC-MH-09-TC-API-001` | Planned — `05_Development/CareBridgeAPI/src/test/java/com/carebridge/backend/health/controller/JourneyMetricControllerTest.java` (not present at Draft baseline) | Not run | Not run | Not run | 🔴 Not written / rerun required |
| `UC-MH-09-TC-API-002` | Planned — `05_Development/CareBridgeAPI/src/test/java/com/carebridge/backend/health/controller/JourneyMetricControllerTest.java` (not present at Draft baseline) | Not run | Not run | Not run | 🔴 Not written / rerun required |
| `UC-MH-09-TC-API-002-VAL` | Planned — `05_Development/CareBridgeAPI/src/test/java/com/carebridge/backend/health/controller/JourneyMetricControllerTest.java` (not present at Draft baseline) | Not run | Not run | Not run | 🔴 Not written / rerun required |
| `UC-MH-09-TC-API-003` | Planned — `05_Development/CareBridgeAPI/src/test/java/com/carebridge/backend/health/controller/JourneyMetricControllerTest.java` (not present at Draft baseline) | Not run | Not run | Not run | 🔴 Not written / rerun required |
| `UC-MH-09-TC-API-004` | Planned — `05_Development/CareBridgeAPI/src/test/java/com/carebridge/backend/health/controller/JourneyMetricControllerTest.java` (not present at Draft baseline) | Not run | Not run | Not run | 🔴 Not written / rerun required |
| `UC-MH-09-TC-API-004-VAL` | Planned — `05_Development/CareBridgeAPI/src/test/java/com/carebridge/backend/health/controller/JourneyMetricControllerTest.java` (not present at Draft baseline) | Not run | Not run | Not run | 🔴 Not written / rerun required |
| `UC-MH-09-TC-BR-001` | `05_Development/CareBridgeAPI/src/test/java/com/carebridge/backend/health/MetricObservationValidatorTest.java` | Not run | Not run | Not run | 🔴 Not written / rerun required |
| `UC-MH-09-TC-BR-002` | `05_Development/CareBridgeAPI/src/test/java/com/carebridge/backend/health/MetricObservationValidatorTest.java` | Not run | Not run | Not run | 🔴 Not written / rerun required |
| `UC-MH-09-TC-SEC-001` | `05_Development/CareBridgeAPI/src/test/java/com/carebridge/backend/health/MetricObservationValidatorTest.java` | Not run | Not run | Not run | 🔴 Not written / rerun required |
| `UC-MH-09-TC-GAP-001` | `05_Development/CareBridgeAPI/src/test/java/com/carebridge/backend/health/MetricObservationValidatorTest.java` | Not run | Not run | Not run | 🔴 Not written / rerun required |
...
| Generic test matrix | Case titles/actions reference `Track Hydration` operations and rules. | Pass |
