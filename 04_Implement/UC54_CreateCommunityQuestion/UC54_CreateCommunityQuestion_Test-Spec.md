...
| ---------------- | ----------------------------------- | --------------------- | ----------- | -------------------------------- |
| `COM-TC-001`     | throw UnsupportedOperationException | 🔴 FAIL                  | ☑ FAIL ☐ PASS      | —                                |
| `COM-TC-002`     | throw UnsupportedOperationException | 🔴 FAIL                  | ☑ FAIL ☐ PASS      | —                                |
| `COM-TC-003`     | throw UnsupportedOperationException | 🔴 FAIL                  | ☑ FAIL ☐ PASS      | —                                |
| `COM-TC-SEC-001` | No service call                     | 🔴 FAIL (security layer) | ☑ FAIL ☐ PASS      | —                                |
| `COM-TC-INT-001` | throw UnsupportedOperationException | 🔴 FAIL                  | ☑ FAIL ☐ PASS      | —                                |
