> [!IMPORTANT]
> Historical resolved-report verification evidence for `UC-AD-17`; this is not a canonical current Test-Spec. Current code and the canonical code-first specification override conflicts.
...
**References:**
- `04_Implement/ModeratorReportsRevert/ModeratorReportsRevert_Architecture-Evidence.md` (`CB-MOD-IMP-015`)
- `05_Development/CareBridgeAPI/src/main/resources/db/migration/V1__init_schema.sql`
- `04_Implement/UndoModerationAction/UndoModerationAction_Architecture-Evidence.md` (`CB-MOD-IMP-009` — nguồn 2 guard "gần nhất"/"trạng thái khớp" được tái sử dụng)
