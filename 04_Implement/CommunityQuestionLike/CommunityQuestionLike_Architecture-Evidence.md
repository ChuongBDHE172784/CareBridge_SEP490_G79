> [!IMPORTANT]
> Historical subflow evidence for `UC-CO-04`; this is not a canonical current TDS. Current code and the canonical code-first specification override conflicts.
...
> Xem file riêng: `CommunityQuestionLike_Verification-Evidence.md` (theo `PHASE-4_Test-Spec.md` template, TDD Red→Green→Refactor).
...
| Test-Spec đi kèm                  | `04_Implement/CommunityQuestionLike/CommunityQuestionLike_Verification-Evidence.md` |
