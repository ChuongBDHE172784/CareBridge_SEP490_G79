...
| ------------ | -------------------------------------- | -------- | ------- | ---------- |
| `CNT-TC-001` | `throw(UnsupportedOperationException)` | 🔴 FAIL   | ☑ FAIL  | —          |
| `CNT-TC-004` | `throw(UnsupportedOperationException)` | 🔴 FAIL   | ☑ FAIL  | —          |
| `CNT-TC-005` | RBAC guard — controller level          | 🔴 FAIL   | ☑ FAIL  | —          |
