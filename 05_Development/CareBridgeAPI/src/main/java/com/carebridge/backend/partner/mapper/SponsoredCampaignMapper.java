...
@Component public class SponsoredCampaignMapper{
 ...
 public SponsoredCampaignListItemResponse toListItem(SponsoredCampaign e){return new SponsoredCampaignListItemResponse(e.getId(),e.getTitle(),e.getDescription(),e.getStartDate(),e.getEndDate(),e.getSponsorLabel(),e.getApprovalStatus(),e.getCreatedAt());}
}
