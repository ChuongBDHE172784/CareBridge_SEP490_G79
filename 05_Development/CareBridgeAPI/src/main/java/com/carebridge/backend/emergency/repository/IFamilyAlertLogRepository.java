...
public class IFamilyAlertLogRepository {
    ...
    public Optional<FamilyAlertLog> findBySessionId(UUID sessionId) {
        return jdbcTemplate.query("""
                SELECT safety_event_id, parent_event_id, created_at,
                ...
                """, resultSet -> {
                    ...
                    return Optional.of(FamilyAlertLog.builder()
                            .id(resultSet.getObject("safety_event_id", UUID.class))
                            .sessionId(resultSet.getObject("parent_event_id", UUID.class))
