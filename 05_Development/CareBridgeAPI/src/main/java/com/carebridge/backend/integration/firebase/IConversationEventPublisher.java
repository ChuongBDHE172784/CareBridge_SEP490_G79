...
/**
 * ADR-DCC-004: writes a minimal signal to the RECIPIENT's Cloud Firestore inbox
 * ({@code userConversationEvents/{recipientUserId}/events/{eventId}}) — never the actor's own inbox
