 ...
 * the {@code moderation_events.target_type} column has no CHECK constraint. EXPERT and USER
 * were added for UC-14 (Report Content or Account): the {@code moderation_cases.target_type}
