-- Widen audit_logs_action_check to add COMMUNITY_PROFILE_CREATED and
-- COMMUNITY_PROFILE_UPDATED, introduced by UC-20 (Create Community Profile) and
-- UC-21 (Update Community Profile). Done in the same migration batch as the enum
-- change, following the established v1-v6 precedent.
