-- Widen audit_logs_action_check to add the 7 new AuditAction values introduced by
-- UC186 (Manage Posture Analysis Configuration: POSTURE_CONFIG_CREATED,
-- POSTURE_CONFIG_UPDATED, POSTURE_CONFIG_ACTIVATED) and UC185 (Manage Pregnancy
-- Exercises: EXERCISE_CREATED, EXERCISE_UPDATED, EXERCISE_ACTIVATED,
-- EXERCISE_DISABLED). Done in the same migration batch as the enum change,
-- following the established v1-v4 precedent.
