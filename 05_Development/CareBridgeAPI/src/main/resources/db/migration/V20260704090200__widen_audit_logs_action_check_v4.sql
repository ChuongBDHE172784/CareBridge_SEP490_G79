-- Widen audit_logs_action_check to add the 3 new AuditAction values introduced by the
-- Admin Governance cluster (UC114 ManageUserAccounts, UC115 CreateStaffAccount,
-- UC116 UpdateRoleAndPermission): USER_ACCOUNT_STATUS_CHANGED, STAFF_ACCOUNT_CREATED,
-- ROLE_PERMISSION_UPDATED. Done in the same migration batch as the enum change,
-- following the established v1/v2/v3 precedent.
