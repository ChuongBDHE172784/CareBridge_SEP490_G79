...
create table consultation_bookings (
        ...
        created_at timestamp(6) with time zone not null,
        price_locked_at timestamp(6) with time zone,
...
create table safety_monitoring_settings (
        ...
        created_at timestamp(6) with time zone not null,
        location_consent_at timestamp(6) with time zone,
        sensor_consent_at timestamp(6) with time zone,
        updated_at timestamp(6) with time zone,
...
create table vaccination_records (
    ...
    alter table if exists otp_verifications 
       add constraint FKssn2wgmijxelm0u26ti271lcf 
       foreign key (user_id) 
       references users;
