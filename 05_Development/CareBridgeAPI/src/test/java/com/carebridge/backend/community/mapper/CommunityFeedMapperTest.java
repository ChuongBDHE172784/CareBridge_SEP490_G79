...
class CommunityFeedMapperTest {
    ...
    void toFeedItem_anonymousQuestion_authorDisplayIsMasked() {
        ...
        CommunityFeedItemResponse response = mapper.toFeedItem(entity, "Thai kỳ", "Nguyễn Thị A", false);
    ...
    void toFeedItem_nonAnonymousQuestion_authorDisplayIsRealName() {
        ...
        CommunityFeedItemResponse response = mapper.toFeedItem(entity, "Thai kỳ", "Trần Thị B", false);
    ...
    void toFeedItem_mapsFieldsCorrectly() {
        ...
        CommunityFeedItemResponse response = mapper.toFeedItem(entity, topicName, displayName, true);
