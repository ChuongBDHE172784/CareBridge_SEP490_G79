...
class BabyDailyLogDetailScreen extends StatefulWidget {
  ...
  @override
  State<BabyDailyLogDetailScreen> createState() => _BabyDailyLogDetailScreenState();
}
  ...
  Future<void> _fetchLogDetail() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Lỗi tải chi tiết nhật ký')),
      );
    } finally {
                ...
                child: Column(
                  children: [
                    ...
                    Column(
                      children: [
                        Container(
                          ...
                          child: const Icon(Icons.restaurant, color: primaryColor, size: 40),
                        ),
                    ...
                    _buildInfoCard(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              _buildDurationSide('TRÁI', _logDetail!['durationLeft']),
                              const SizedBox(width: 24),
                              _buildDurationSide('PHẢI', _logDetail!['durationRight']),
                            ],
                          )
                        ],
                      ),
                      ...
                      child: Column(
                        ...
                        children: [
                          Wrap(
                            spacing: 8,
                            runSpacing: 8,
                            children: (_logDetail!['status'] as List<String>).map((status) {
                              return Container(
                    ...
                    ElevatedButton.icon(
                      ...
                      label: const Text('Chỉnh sửa', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                    ...
                    OutlinedButton.icon(
                      ...
                      label: Text(
                        ...
                        style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: errorColor),
                      ),
