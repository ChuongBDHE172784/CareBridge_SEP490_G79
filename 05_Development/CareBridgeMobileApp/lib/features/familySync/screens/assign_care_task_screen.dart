  ...
  Future<void> _submit() async {
    ...
    if (_selectedAssignee == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Vui lòng chọn người thực hiện')),
      );
      return;
    }
    if (_dueAt == null) {
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(const SnackBar(content: Text('Vui lòng chọn hạn chót')));
      return;
    }
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Đã giao việc thành công!')),
        );
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    Text(
                                      '${_members.length} thành viên khả dụng',
                                      style: const TextStyle(
                                        fontSize: 14,
                                        color: Color(0xFF524440),
                                        fontFamily: 'Quicksand',
                    ...
                    const Text(
                      'Phân bổ trách nhiệm để mọi người cùng chung tay.',
                      style: TextStyle(
                        fontSize: 14,
                        color: Color(0xFF524440),
                        fontFamily: 'Quicksand',
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                shape: BoxShape.circle,
                border: isSelected
                    ? Border.all(color: const Color(0xFFC98C7B), width: 3)
