...
class _MyCareGroupsScreenState extends State<MyCareGroupsScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      if (mounted) setState(() { _groups = list; _pendingInviteCount = invites.length; _loading = false; });
    } catch (_) {
  ...
  void _openInvitations() {
    Navigator.push(context, MaterialPageRoute(builder: (_) => const PendingInvitationsScreen())).then((_) => _load());
  }
  ...
  Future<void> _leaveGroup(CareGroup g) async {
    final ok = await showDialog<bool>(
      ...
      builder: (_) => AlertDialog(
        ...
        title: const Text('Rời nhóm?', style: TextStyle(fontFamily: 'Lexend', fontWeight: FontWeight.w600)),
        content: Text('Bạn sẽ không còn xem được thông tin nhóm "${g.groupName}".', style: const TextStyle(fontFamily: 'Lexend')),
        actions: [
          ...
          FilledButton(
            ...
            child: const Text('Rời nhóm', style: TextStyle(fontFamily: 'Lexend')),
          ),
        ],
      ),
    );
    ...
    return Container(
      ...
      child: Column(
        children: [
            ...
            children: [
              ...
              IconButton(
                ...
                icon: Badge(
                  ...
                  child: const Icon(Icons.mail_outline, color: _onSurfaceVariant),
                ),
              ),
            ],
          ),
          ...
          const Text('CareBridge', style: TextStyle(fontFamily: 'Lexend', fontSize: 18, fontWeight: FontWeight.w700, color: Color(0xFF271812))),
          const SizedBox(height: 4),
          const Text('Nhóm chăm sóc của tôi',
              style: TextStyle(fontFamily: 'Lexend', fontSize: 14, color: Color(0xFF524440))),
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(color: _primaryContainer.withAlpha(102), style: BorderStyle.solid),
            ),
            child: Row(
              children: [
                ...
                const Expanded(
                  child: Text('Nhập mã nhóm để tham gia nhóm mới',
                      style: TextStyle(fontFamily: 'Lexend', fontSize: 14, color: Color(0xFF524440))),
                ),
                TextButton(
                  onPressed: () {},
                  child: const Text('Tham gia', style: TextStyle(fontFamily: 'Lexend', color: Color(0xFFC98C7B))),
                ),
              ],
            ),
          ),
    ...
    return ListView.separated(
      ...
      itemBuilder: (_, i) => _GroupCard(
        ...
        onDetail: () => Navigator.push(context, MaterialPageRoute(
          builder: (_) => CareGroupDetailScreen(groupId: _groups[i].id, groupName: _groups[i].groupName),
        )),
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          const Text('Chưa có nhóm nào', style: TextStyle(fontFamily: 'Lexend', fontSize: 20, fontWeight: FontWeight.w600, color: Color(0xFF271812))),
          const SizedBox(height: 8),
          const Text('Nhập mã nhóm để tham gia', style: TextStyle(fontFamily: 'Lexend', color: Color(0xFF524440))),
        ],
      ),
    );
  }
...
class _GroupCard extends StatelessWidget {
  ...
  const _GroupCard({required this.group, required this.onDetail, required this.onLeave});
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        const Icon(Icons.people, size: 14, color: Color(0xFF524440)),
              ...
              if (group.myRole != null)
                Container(
                  ...
                  child: Text(
                    group.myRole == 'ADMIN' || group.myRole == 'OWNER' ? 'Quản trị' : 'Thành viên',
                    style: TextStyle(
                      fontFamily: 'Lexend', fontSize: 11, fontWeight: FontWeight.w600,
                      color: group.myRole == 'ADMIN' || group.myRole == 'OWNER'
          ...
          if (group.myPermission != null) ...[
            ...
            Container(
              ...
              child: Row(
                mainAxisSize: MainAxisSize.min,
                children: [
                  const Icon(Icons.shield_outlined, size: 14, color: Color(0xFF6E5A52)),
                  const SizedBox(width: 4),
                  Text(group.myPermission!,
            ...
            children: [
              Expanded(
                child: FilledButton(
                  ...
                  child: const Text('Chi tiết', style: TextStyle(fontFamily: 'Lexend')),
                ),
              ),
              const SizedBox(width: 12),
              Container(
