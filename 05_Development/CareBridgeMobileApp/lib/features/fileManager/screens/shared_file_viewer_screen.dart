...
class _SharedFileViewerScreenState extends State<SharedFileViewerScreen> {
  ...
  Future<void> _loadFile() async {
    ...
    try {
      ...
      final expired =
          widget.accessExpiry != null &&
          widget.accessExpiry!.isBefore(DateTime.now());
      setState(() {
        _file = f;
        _isExpired = expired;
      });
  ...
  Future<void> _openFullscreen() async {
    ...
    if (url == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Tài liệu chưa sẵn sàng.'),
      ...
      child: Column(
        ...
        children: [
          ...
          if (widget.patientName != null)
            _infoRow(Icons.person_rounded, 'Bệnh nhân', widget.patientName!),
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: isExpired
              ...
              : _primaryContainer.withAlpha(60),
          width: 1.5,
        ),
        boxShadow: [
          BoxShadow(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(
                ...
                color: isExpired ? Colors.red : _primary,
                size: 18,
              ),
              ...
              Text(
                ...
                style: TextStyle(
                  ...
                  fontSize: 13,
                  fontWeight: FontWeight.w600,
                  color: isExpired ? Colors.red : _onSurface,
                ),
              ),
            ],
          ),
          ...
          _consentRow(
            'Quyền truy cập',
            isExpired ? 'Đã hết hạn' : 'Có thời hạn',
            isExpired ? Colors.red : const Color(0xFF4CAF50),
          ),
          const SizedBox(height: 10),
