        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                _sent
                    ? 'Mã xác nhận đã được gửi. Vui lòng kiểm tra email hoặc tin nhắn.'
                    : 'Vui lòng nhập email hoặc số điện thoại đã đăng ký. Chúng tôi sẽ gửi mã xác nhận để đặt lại mật khẩu.',
              ...
              SizedBox(
                ...
                child: FilledButton(
                  ...
                  child: _isSubmitting
                      ...
                      : Text(
                          _sent ? 'Tiếp tục đặt lại mật khẩu' : 'Gửi mã',
                          style: const TextStyle(
                            fontFamily: 'Lexend',
                            fontSize: 16,
