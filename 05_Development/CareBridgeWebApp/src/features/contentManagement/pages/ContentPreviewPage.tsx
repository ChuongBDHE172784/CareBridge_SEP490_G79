...
export default function ContentPreviewPage() {
  ...
  return (
    <div className="min-h-screen font-sans" style={{ background: 'radial-gradient(ellipse at 50% 30%, #ffe9e3 0%, #F6F1EC 70%)' }}>
      {/* Toolbar */}
      ...
      <div className="flex justify-center items-start py-12 px-8 min-h-[calc(100vh-60px)]">
        {viewMode === 'mobile' ? (
          /* Mobile device frame */
          <div
            className="w-[390px] h-[844px] rounded-[40px] border-8 border-[#FADCD3] bg-surface overflow-hidden flex flex-col"
            style={{ boxShadow: '0 24px 80px rgba(90,70,63,0.18), 0 8px 32px rgba(90,70,63,0.08)' }}
          >
            {/* Status bar mockup */}
            <div className="h-12 bg-surface-bright flex items-center justify-between px-6 shrink-0">
              ...
              <div className="flex gap-1.5 items-center">
                <span className="material-symbols-outlined text-on-surface-variant" style={{ fontSize: 16 }}>signal_cellular_alt</span>
                <span className="material-symbols-outlined text-on-surface-variant" style={{ fontSize: 16 }}>wifi</span>
                <span className="material-symbols-outlined text-on-surface-variant" style={{ fontSize: 16 }}>battery_full</span>
              </div>
            </div>
            ...
            <div className="flex-1 overflow-y-auto">
              ...
              >
                <span className="material-symbols-outlined text-[#C98C7B]" style={{ fontSize: 40 }}>image</span>
              </div>
          ...
          /* Desktop frame */
          <div
            className="w-full max-w-[900px] bg-surface rounded-2xl overflow-hidden"
            style={{ boxShadow: '0 24px 80px rgba(90,70,63,0.12)' }}
          >
            ...
            <div className="p-10">
              {/* Hero image */}
              <div
                className="w-full h-[300px] rounded-xl flex items-center justify-center mb-8"
                style={{ background: 'linear-gradient(135deg, #FFE9E3 0%, #F6DACF 100%)' }}
              >
                <span className="material-symbols-outlined text-[#C98C7B]" style={{ fontSize: 56 }}>image</span>
              </div>
