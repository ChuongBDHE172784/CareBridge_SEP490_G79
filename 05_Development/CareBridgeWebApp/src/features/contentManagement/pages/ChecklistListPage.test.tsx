...
describe('UC82-69-WEB-001 admin checklist boundary', () => {
  ...
  it('enables actions according to the checklist lifecycle', async () => {
    ...
    expect(screen.getByTestId('checklist-list-page').className).toContain('bg-[#F6F1EC]');
    expect(screen.getByTestId('checklist-list-page').className).toContain("font-['Lexend',sans-serif]");
    expect(screen.getByRole('heading', { name: 'Quản lý Checklist' }).className).toContain('text-[#5A463F]');
