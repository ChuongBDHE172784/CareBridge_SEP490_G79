...
const SUBSTAGE_OPTIONS: Partial<Record<ContentStage, ChecklistSubstage[]>> = {
  ...
  BABY_CARE: [
    { code: 'BABY_CARE_DAY_0_28', anchor: 'BIRTH_DATE', startInclusive: 0, endInclusive: 28, unit: 'DAY' },
    { code: 'BABY_CARE_MONTH_0_3', anchor: 'BIRTH_DATE', startInclusive: 0, endInclusive: 3, unit: 'MONTH' },
  ],
};

const AUTHORABLE_STAGES: ContentStage[] = ['PRE_PREGNANCY', 'PREGNANCY', 'POSTPARTUM', 'BABY_CARE'];
