            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <ul className="mb-0 mt-3 list-none space-y-1 p-0 text-sm">
                  <li><a href={`mailto:${SUPPORT_EMAIL}`} className="font-semibold text-primary no-underline hover:underline">{SUPPORT_EMAIL}</a></li>
                  {SUPPORT_PHONE && <li><a href={`tel:${SUPPORT_PHONE}`} className="font-semibold text-primary no-underline hover:underline">{SUPPORT_PHONE}</a></li>}
                </ul>
              </div>
            </div>
          </div>
