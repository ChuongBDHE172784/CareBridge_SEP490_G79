...
const PUBLIC_AUTH_PATHS = ['/auth/register', '/auth/phone/register', '/auth/login', '/auth/phone/login', '/auth/login-direct', '/auth/verify-otp', '/auth/resend-otp', '/auth/forgot-password', '/auth/lock-appeals'];
