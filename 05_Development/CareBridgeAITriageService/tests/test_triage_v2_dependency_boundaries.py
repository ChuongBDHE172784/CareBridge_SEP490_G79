...
V2_ROOT = Path(__file__).parents[1] / "app" / "triage_v2"


def test_v2_never_imports_legacy_graph_outcome_or_open_web_modules():
    forbidden = {
...
def test_v2_has_no_runtime_web_or_autonomous_agent_primitive():
