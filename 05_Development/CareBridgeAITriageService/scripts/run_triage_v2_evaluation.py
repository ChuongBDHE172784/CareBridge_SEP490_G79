...
class LocalGeminiFaultFixture:
    ...
    def extract_triage_v2(self, *, text: str, deadline: float | None = None) -> None:
        return self._client.extract_triage_v2(text=text, deadline=deadline)
...
def _evaluate_vague_case(case: dict[str, object], index: int) -> dict[str, object]:
    ...
    for turn_index, turn in enumerate(authored_turns):
        ...
        result = dict(build_triage_v2_graph().invoke(state, graph_config(session_id)))
