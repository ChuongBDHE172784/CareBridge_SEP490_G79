"""Deterministic, side-effect-free input boundary for AI Triage."""
...
from app.triage.state import MAXIMUM_QUESTION_ROUNDS, TriageState
...
_LIST_LIMITS = {
    ...
    "askedQuestionIds": 36,
    "submittedOptionQuestionIds": 8,
    "submittedOptionCodes": 8,
    "unknownFields": 128,
...
def _require_complete_state(state: Mapping[str, object]) -> None:
    for field in TriageState.__required_keys__:
